...
class SandboxBackgroundComponent : IDynamicComponent {

    override fun getName(): String = CcNames.SANDBOX_BACKGROUND

    override fun onCall(cc: CC): Boolean {
        ARouter.getInstance().build(RoutePaths.SANDBOX_BACKGROUND).navigation(cc.context)
